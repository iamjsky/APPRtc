...
import com.soundleader.apprtctest.RecordedAudioToFileController;
import com.soundleader.apprtctest.RtcEventLog;
...
public class PeerConnectionClient {
    ...
    private final PeerConnectionClient.PCObserver pcObserver = new PeerConnectionClient.PCObserver();
    private final PeerConnectionClient.SDPObserver sdpObserver = new PeerConnectionClient.SDPObserver();
...
//    private SignalingParameters signalingParameters;
    private List<PeerConnection.IceServer> signalingIceServers;
    ...
    public static class PeerConnectionParameters {
        ...
        private final PeerConnectionClient.DataChannelParameters dataChannelParameters;
    ...
    public interface PeerConnectionEvents {
        ...
        void onDataChanelMessageReceive(String message);
    ...
    public PeerConnectionClient(Context appContext, EglBase eglBase,
                                PeerConnectionClient.PeerConnectionParameters peerConnectionParameters, PeerConnectionClient.PeerConnectionEvents events) {
    ...
    public void createPeerConnection(final VideoSink localRender, final VideoSink remoteSink,
        ...
        createPeerConnection(
                localRender, Collections.singletonList(remoteSink), videoCapturer, iceServers);
    }
    ...
    public void createPeerConnection(final VideoSink localRender, final List<VideoSink> remoteSinks,
        ...
        this.signalingIceServers = iceServers;
    ...
    private void createPeerConnectionInternal() {
        ...
        PeerConnection.RTCConfiguration rtcConfig =
                new PeerConnection.RTCConfiguration(signalingIceServers);
...
//        Log.e(TAG, "Peerconnection error: " + errorMessage);
    ...
    private static String getSdpVideoCodecName(PeerConnectionClient.PeerConnectionParameters parameters) {
...
//                        Log.d(TAG, "Received binary msg over " + dc);
                    ...
                    events.onDataChanelMessageReceive(strData);
